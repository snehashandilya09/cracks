  ...
  const [batches, setBatches] = useState<Batch[]>([
    {
      ...
      nullifiers: ["0x1234...5678", "0x9abc...def0", "0x2468...ace0"],
    },
    {
      id: 2,
      status: "LOGGED",
      ...
      nullifiers: ["0x3579...bdf1", "0x2468...bdf2"],
    },
    {
      id: 3,
      status: "PENDING",
    ...
    const interval = setInterval(() => {
      setBatches(prev =>
        prev.map(batch => {
          ...
          const blocksUntilFinality = Math.max(0, LOOKBACK_DISTANCE - (batch.currentBlock + 1 - batch.l1BlockNumber));
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-slate-600">Monitor settlement batch finalization and reorg protection mechanisms</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 rounded-lg border-2 border-blue-300 bg-blue-50 p-6">
          ...
          <p className="mt-2 text-sm text-blue-800">
            ClearSettle uses a multi-stage finality model to protect against chain reorganizations. Each batch
            progresses through stages, becoming increasingly immutable at each step.
          </p>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            {batches.map(batch => (
              <div key={batch.id} className={`rounded-lg border-2 p-6 transition-all ${getStatusColor(batch.status)}`}>
                ...
                <div className="mt-4">
                  ...
                  <div className="h-3 overflow-hidden rounded-full bg-slate-200">
                    <div
                      ...
                      style={{
                        width: `${(((LOOKBACK_DISTANCE - batch.blocksUntilFinality) / LOOKBACK_DISTANCE) * 100).toFixed(
                          0,
                        )}%`,
                      }}
                    />
                ...
                <div className="mt-4 rounded-lg bg-white bg-opacity-50 p-3">
                  ...
                  {batch.status === "LOGGED" && (
                    <div className="text-sm text-blue-800">
                      ...
                      <p>
                        Batch is logged but within the reorg window. Safe from shallow reorgs (&lt;12 blocks) but
                        monitor for deep reorgs. <strong>{batch.blocksUntilFinality} blocks until immutability</strong>.
                      </p>
                    </div>
                  )}
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-lg border border-slate-200 bg-white p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-700 ml-4">
              <li>
                • <strong>Nullifiers:</strong> keccak256(sender || nonce || payload) - does not include block number
              </li>
              <li>
                • <strong>Consumed tracking:</strong> Smart contract tracks which nullifiers have been used
              </li>
              <li>
                • <strong>Replay prevention:</strong> Using a nullifier twice is rejected onchain
              </li>
              <li>
                • <strong>Settlement idempotence:</strong> Settling same orders twice fails gracefully
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-700 ml-4">
              <li>
                • <strong>Parent hash verification:</strong> Each batch proves parent hash matches history
              </li>
              <li>
                • <strong>Canonical chain:</strong> Only one parent hash = one valid chain at each height
              </li>
              <li>
                • <strong>Fork detection:</strong> Different parent hash = chain reorg detected
              </li>
              <li>
                • <strong>Dispute window:</strong> Can challenge batches within safety buffer
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-700 ml-4">
              ...
              <li>
                • <strong>Detection:</strong> Such an attack would be publicly noticed immediately
              </li>
              <li>
                • <strong>Recovery:</strong> Even if reorg happens, idempotence protects users
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-6">
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-700 ml-4">
              <li>
                • <strong>Layer 1:</strong> Commit-reveal hides orders during vulnerability window
              </li>
              <li>
                • <strong>Layer 2:</strong> Safety buffer ensures finality before settlement
              </li>
              <li>
                • <strong>Layer 3:</strong> Idempotent execution survives temporary reverts
              </li>
              <li>
                • <strong>Layer 4:</strong> Nullifier tracking prevents double-spending
              </li>
            </ul>
          </div>
        </div>
